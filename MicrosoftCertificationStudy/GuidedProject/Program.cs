...
for (int i = 0; i < maxPets; i++)
{
    switch (i)
    {
        case 0:
            ...
            animalPhysicalDescription = "medium sized cream colored female golden retriever weighing about 65 pounds.";
            animalNickname = "lola";
            break;
            case 1:
            animalSpecies = "dog";
    ...
    switch (menuSelection)
    {
        ...
        case "2":   // Add animal to array
            ...
            while (anotherPet== "y" && petCount < maxPets)
            {
                ...
                do
                {
                    Console.WriteLine("Enter a physical description of pet");
                    readResult = Console.ReadLine(); 
                    if ( readResult != null)
                    {
                ...
                do
                {
                    Console.WriteLine("Enter a descripiton of your pets personality");
        ...
        case "3":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                if (ourAnimals[i, 0] != "" && ourAnimals[i, 2] == "Age: ?")
                {
                    do
                    {
                        int petAge;
                        ...
                        readResult = Console.ReadLine();
                        if (readResult != "" && int.TryParse(readResult, out petAge))
                        {

                            ourAnimals[i, 2] = ourAnimals[i,2].Substring(0,5) + Convert.ToString(petAge);
                            validInput = true;
                        }
                ...
                if ((ourAnimals[i, 0] != "" && ourAnimals[i,0] != "ID #: ") && ourAnimals[i, 4] == "Physical description: ")
                {
                    do
                    {
